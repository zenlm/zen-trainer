# zen-trainer — AI Knowledge Base

**Project**: zen-trainer
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-trainer
**HuggingFace**: https://huggingface.co/zenlm/zen-trainer
**Last Updated**: 2026-02-27

## Overview

zen-trainer is part of the Zen AI model family by Hanzo AI / Zen LM.
